...
<div class="display-table">
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    <li><a href="<?php echo base_url();?>index.php/brands/go/camera"><span class="hidden-xs hidden-sm">Cameras</span></a></li>
                    <li class="active"><a href="<?php echo base_url();?>index.php/brands/go/camera"><span class="hidden-xs hidden-sm">CCTV Cameras</span></a></li>
